...
/opt/hand-workbench-venv/bin/python -m pip install --disable-pip-version-check 'wuji-sdk==2026.8.31' 'numpy>=2.2,<3' 'eclipse-zenoh==1.9.0'
...
install -d -o workbench -g workbench /home/workbench/.wuji /home/workbench/.wuji/logs
