...
(()=>{
 ...
 const program=document.createElement('section');program.className='wb-card';program.id='wb-program';
 program.innerHTML=`<h3 id="wb-program-title"></h3><p id="wb-program-note"></p><div class="wb-row"><select id="wb-dance-add"></select><button id="wb-dance-add-button"></button><button id="wb-dance-all"></button></div><div id="wb-entries" class="wb-list"></div><div class="wb-row"><label for="wb-order" id="wb-order-label"></label><select id="wb-order"><option value="sequence"></option><option value="shuffle"></option></select><label for="wb-repeats" id="wb-repeats-label"></label><input id="wb-repeats" type="number" min="0" max="100" step="1" value="1"><label for="wb-seed" id="wb-seed-label"></label><input id="wb-seed" type="number" min="0" max="4294967295" step="1" value="0"></div><div class="wb-actions"><button id="wb-program-preview"></button><button id="wb-program-hardware" class="primary"></button><button id="wb-program-pause"></button><button id="wb-program-stop"></button></div><p id="wb-program-status" class="wb-status" role="status"></p></section>`;
