...
(function (global) {
  ...
  var ZH = {
    ...
    records: '运行记录', connection: '连接与校准', library: '动作展示', interaction: '触碰互动', doctor: '官方诊断', connect: '连接设备',
  ...
  var EN = {
    ...
    records: 'Records', connection: 'Connection', library: 'Actions', interaction: 'Interaction', doctor: 'Diagnostics', connect: 'Connect',
