(() => {
  ...
  const translations={
    ...
    '真实手 · 动作播放':'Real hand · Playback','开始真实手动作':'Start hand motion','暂停实机':'Pause hand','继续实机':'Resume hand','停止实机并停用电机':'Stop and disable motors',
    ...
    '连接设备':'Connect device','断开连接':'Disconnect','连接设备':'Connect device','未连接':'Disconnected','设备已连接':'Device connected','连接中':'Connecting','反馈过期':'Feedback stale','服务未连接':'Service offline',
  ...
  Object.assign(translations,{
    ...
    '查看手部姿态与每个关节的反馈。':'Inspect the hand pose and per-joint feedback.',
    ...
    '连接设备，检查显示映射与单关节对应。':'Connect the selected hand and check the display/joint mapping.',
    ...
    '正在连接本机虚拟机并核对设备':'Connecting to the local VM and checking handedness',
